...
When i18n is enabled, file-based pages are automatically placed under the language segment (e.g. `/my-page` -> `/en/my-page`), and the language is added to their static paths for you. Disable that behavior with `autoI18n: false`:
